...
2. Make sure that your shell is using awscli for python2.7. If not, set up manually your awscli environment with python2.7 or just execute this following command `virtualenv your-venv -p python2.7 && pip install --upgrade --user awscli && source your-venv/bin/activate`
